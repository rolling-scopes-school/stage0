...
* После смены имени должен измениться аватар пользователя: 
...
- Создайте HTML-файл с основным макетом и CSS-стилями для него. Файл не должен содержать ничего кроме тега <body>.
...
- [ ] **+20** - Дублирование кода (Функций и методов) сведено к минимуму
...
- [ ] **+10** - реализовать бота способного проанализировать шаги игрока и просчитывать наиболее выгодные ходы не менее чем на два хода (Проверяется ментором)
- [ ] **+5** - создать бота способного придерживаться любой тактики. (Проверяется ментором)
- [ ] **+10** - создать адаптивного бота способного менять тактики в зависимости от ситуации. (Проверяется ментором)
