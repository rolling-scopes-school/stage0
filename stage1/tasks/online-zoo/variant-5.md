...
- Есть хотя бы один блок, который не меняет цвет фона. **-5**.
- Есть хотя бы один элмент, который не меняет цвет. **-5**.
...
- При нажатии на картинку справа, выбранный элемент занимает позицию текущего активного элемента или элементы не смещаются налево. **-5**.
- Карточка (или 2 крточки) не становятся размером как карточка орла на макете. **-5**.
...
3. **Карусель** в блоке Pets in Zoo сделана и реагирует на нажатие кнопок вправо/влево и на ползунок на полосе прогресса **+15**. Баллы снимаем, если:
