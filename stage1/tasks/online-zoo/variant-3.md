...
Выполнить задание согласно макету автора *Vlad*: **[Online Zoo](https://www.figma.com/file/74wXlorl9mZQP0uhqDg83j/Online-Zoo)**
...
Все фоновые элементы макета должны растягиваться на всю доступную ширину экрана, если ширина больше 1920px. При этом направляющие должны сохраняться в исходном размере, 1400px. Особенностью этого проекта яляются элементы, выходящие за границы направлюящих (карточки животных, отзывы). Важно, что ни в коем случае, на странице не должна появляться горизонтальная полоса прокрутки. О таких случаях будет сказано в технических требованиях соотвествующих блоков.
...
2. **Side bar** (`<aside>` содержит кнопки соц. сетей)
...
- Кнопка `Choose zoo` должна быть интерактивной. Нажатие перебрасывает нас на Map Page.
...
6. Блок **Pay and feed**
- Заголовки, текст и картинки - это все разные элементы.

7. Блок **Testimonials**
- Кнопка `Leave Feedback` должна быть интерактивной.
- Кнопка `See more reviews` должна быть интерактивной. При нажатии ничего происходить не должно.
- Кнопки влево и вправо должны быть интерактивными.

8. Блок **Zoogeography**
- На карте должно быть 4 интерактивных иконки. При наведении должна быть анимация, когда элемент увеличивается и меняет цвет.
- По умолчанию выбран Eagle, панель слева показывает описание.
- Кнопка `Watch now` перебрасывает нас на Zoos Translation с соотвествующим животным.
...
-- Testimonials  
-- Zoogeography  
- Кнопка `Donate for volunteers` должна быть интерактивной. При нажатии ничего происходить не должно.
