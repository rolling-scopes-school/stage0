...
- Нажатие на `Map` перебрасывает нас на страницу Map.
- Нажатие на `Contact Us` перебрасывает нас на страницу Contact Us (либо 404).
...
7. **Footer** (`<footer>` содержит меню, доготипы и кнопки доната):
...
3. **Footer** (`<footer>` содержит меню, логотипы и кнопки доната и соц. сетей):
- Интерактивная панель навигации. По умолчанию, элементы не имеют подсветки.
- Нажатие на `About` перебрасывает нас на Landing.
...
5. **Footer** (`<footer>` содержит меню, доготипы и кнопки доната):
- Интерактивная панель навигации. По умолчанию, элементы не имеют подсветки.
- Нажатие на `About` перебрасывает нас на Landing.
- Нажатие на `Map` перебрасывает нас на Map.
- Нажатие на `Contact Us` перебрасывает нас на Contact Us (либо 404).
