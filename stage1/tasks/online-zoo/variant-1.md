...
Все фоновые элементы макета должны растягиваться на всю доступную ширину экрана, если ширина больше 1920px. При этом направляющие должны сохраняться в исходном размере, 1480px. Особенностью этого проекта являются:
...
1. **Header** (`<header>` содержит только логотип, панель навигации, иконку поиска, кнопки логина)
...
- (1) ❗ Нажатие на `Map` перебрасывает нас на *страницу с картой*.
- (1) ❗ Нажатие на `Zoos` перебрасывает нас на *страницу с животным: пандой*.
...
- Кнопки `sign in` и `sign up` должны быть интерактивными. При нажатии может ничего не происходить.
...
- (1) Задний фон можно делать несколькими способами:  
...
- (1) ❗ При наведении курсора должна быть анимация [прокручивания рамки картинки](https://www.w3schools.com/css/css3_2dtransforms.asp) на 360 градусов за 0.3 - 0.5 секунд по часововй стрелке. При уходе курсора за границы карточки, та же анимация, но против часововй стрелки. Либо медленная бесконечная анимация повоторота.
- Картинки животных можно найти на 

5. Блок **Pay and feed**
- (6) Кнопка `Donate to volunteers` должна быть интерактивной. При нажатии может ничего не происходить.
...
- На блоках с отзывами должен быть [выступ треуголной формы](http://apps.eky.hk/css-triangle-generator/).

5. Блок **Look at this beautiful animals**
- Кнопка `Choose your favorite` должна быть интерактивной. Нажатие перебрасывает нас на *страницу с картой*.
- (6) Кнопки влево и вправо должны быть интерактивными. При нажатии может ничего не происходить.
...
- (1) ❗ При наведении курсора на иконки должна быть анимация [прокручивания рамки картинки](https://www.w3schools.com/css/css3_2dtransforms.asp) на 360 градусов за 0.3 - 0.5 секунд по часововй стрелке. При уходе курсора за границы иконки, та же анимация, но против часововй стрелки. Либо медленная бесконечная анимация повоторота.
