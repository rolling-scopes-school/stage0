...
- Кнопка complete donation не становится активной после верификации на непустые значения **-5**.
...
2. **Сайдбар** раскрывается и скрывается по нажатию **+15**. Баллы снимаем, если:
...
1. **Карусель** в блоке more live views существует и реагирует на нажатие **+5**. Баллы снимаем, если:
- С момента загрузки, при нажитии на картинку видео в блоке more live views, этот элемент не стаонвится на место основного видео, или основное видео не становится второстепенным элементом в блоке more live views **-5**.
