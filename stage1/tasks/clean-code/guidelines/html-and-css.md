...
Избегайте использования селекторов тега элемента, а также комбинирования тегов с другими селекторами, кроме тех случаев, когда это необходимо (например с классами-помощниками).
