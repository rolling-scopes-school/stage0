...
- можно провести мышкой с зажатой левой или правой кнопкой по клавишам пианино, при этом будут проигрываться соответствующие данным клавишам ноты. Клавиши, над которыми в данный момент находится мышка, переходят в активное состояние  
...
- активное состояние клавиш пианино и соответствующих им букв или нот по стилю отличается от и неактивного состояния и состояния при наведении: изменяется цвет клавиши, трансформация клавиши, цвет соответствующей данной клавише буквы или ноты. Дополнительно к перечисленным можно добавить другие эффекты на ваше усмотрение.  
...
- при клике по клавише клавиатуры, которая соответствует клавише пианино, клавиша переходит в активное состояние +5
- можно провести мышкой с зажатой левой или правой кнопкой по клавишам пианино, при этом будут проигрываться соответствующие данным клавишам ноты +5
- можно провести мышкой с зажатой левой или правой кнопкой по клавишам пианино, при этом клавиши, над которыми в данный момент находится мышка, переходят в активное состояние +5
